...
%                     [L,W_out,H1_out,H2_out] =  CMNMF_LF(MaxIter,InnerMaxIter,V1,V2,W,H1,H2,M,alpha,gama,lamta1,lamta2);
%                      
%                          directory='../../5_6_result_2015/CMNMF/CMNMF_LF';
%                          if(~exist(directory,'dir'))
%                              mkdir(directory);
%                          end
%                        
%                          fn = ['../../5_6_result_2015/CMNMF/CMNMF_LF/CMNMF_simple_alpha' num2str(alpha)  '_gama&' num2str(gama) '_lamta1&' num2str(lamta1)  '_lamta2&' num2str(lamta2) '_t' num2str(t) '.mat'];
%                          disp([datestr(now) ':  '  fn ]);
    ...
    for ga=1:b
        ...
        for j=1:c
            ...
            for k=1:d
                ...
                [Z_filter{location,t},pathway_gene_mgi_id{location,t}]= predicted_pathway_old(W_out,T,mgi_id);
